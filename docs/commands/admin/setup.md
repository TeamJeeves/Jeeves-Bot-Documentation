...
Once you have setup your welcome setting in discord you want to head over to your server settings on the Jeeves site. For more info head over to the [server management](/guides/Using-Jeeves-Website.md#Server Management) page for more information.
